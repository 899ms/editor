...
export const grassDefinition: GrassDefinition = {
  ...
  toolHints: [
    { key: 'Left click', label: 'Plant grass', labelKey: 'editor:nature.hints.plantGrass' },
    { key: 'Esc', label: 'Stop', labelKey: 'editor:nature.hints.stop' },
  ],

  presentation: {
    label: 'Grass',
    labelKey: 'editor:nature.kinds.grass',
    description: 'A procedural grass tuft. Meadow, fescue, or reed.',
    descriptionKey: 'editor:nature.kindDescriptions.grass',
