...
export const flowerDefinition: FlowerDefinition = {
  ...
  toolHints: [
    { key: 'Left click', label: 'Plant flower', labelKey: 'editor:nature.hints.plantFlower' },
    { key: 'Esc', label: 'Stop', labelKey: 'editor:nature.hints.stop' },
  ],

  presentation: {
    label: 'Flower',
    labelKey: 'editor:nature.kinds.flower',
    description: 'A procedural flower. Daisy, tulip, or lavender.',
    descriptionKey: 'editor:nature.kindDescriptions.flower',
