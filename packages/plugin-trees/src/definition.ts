...
export const treeDefinition: TreeDefinition = {
  ...
  tool: () => import('./tool'),
  toolHints: [
    { key: 'Left click', label: 'Plant tree', labelKey: 'editor:nature.hints.plantTree' },
    { key: 'Esc', label: 'Stop', labelKey: 'editor:nature.hints.stop' },
  ],

  presentation: {
    label: 'Tree',
    labelKey: 'editor:nature.kinds.tree',
    description: 'A procedural ez-tree. Oak, pine, aspen, ash, bush, or trellis.',
    descriptionKey: 'editor:nature.kindDescriptions.tree',
